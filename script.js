...
function viewProfile() {
    showNotification('Profile view is not implemented yet', 'info');
    toggleUserMenu();
}

function viewSettings() {
    showNotification('Settings page is not implemented yet', 'info');
    toggleUserMenu();
}
